/**
 * world.js
 * Declarative city/world tuning data.
 */
...
export const CITY_DEFS = [
  {
    ...
    startWealth: 800,
    naturalProduction: { wheat: 8, timber: 5, cotton: 4 },
    dailyConsumption: { bread: 6, tools: 1, cloth: 2 },
    startInventory: {
  ...
  },
  {
    ...
    startWealth: 1200,
    naturalProduction: { iron_ore: 20, coal: 18 },
    dailyConsumption: { bread: 10, tools: 3, timber: 4, cloth: 3 },
    startInventory: {
  ...
  },
  {
    ...
    startWealth: 900,
    naturalProduction: { wheat: 30, cotton: 22, timber: 10 },
    dailyConsumption: { bread: 14, tools: 4, cloth: 5, steam_cores: 1 },
    startInventory: {
  ...
  },
  {
    ...
    startPopulation: 900,
    startWealth: 2000,
    naturalProduction: { mana_crystals: 8, iron_ore: 5 },
    dailyConsumption: { bread: 4, tools: 2, timber: 3, cloth: 1, alchemical_compounds: 1 },
    startInventory: {
  ...
  },
  {
    ...
    startWealth: 1500,
    naturalProduction: { flour: 8, lumber: 6, coal: 4 },
    dailyConsumption: {
      bread: 8,
      steam_cores: 3,
      fine_garments: 2,
...
export const CITY_DEF_MAP = Object.fromEntries(
  CITY_DEFS.map(def => [def.id, def])
);
